...
/**
 * Esta es una interfaz de servicio. En la programación orientada a objetos y en arquitecturas como la de Spring, una interfaz actúa como un "contrato" o un "plano".
 * <p>
 * ¿Qué es un contrato? Un contrato define QUÉ se debe hacer, pero no CÓMO se debe hacer. En este caso, la interfaz Itf_VacanteService establece que cualquier clase que
...
public interface Itf_VacanteService {
	...
	/**
	 * Firma del método que forma parte del contrato del servicio de vacantes. Toda clase que implemente esta interfaz está OBLIGADA a proporcionar una implementación para
	 * este método.
	 * <p>
	 * Propósito: Recuperar y devolver una lista con todos los objetos de tipo Vacante disponibles en la fuente de datos (sea una lista en memoria, una base de datos, un
	 * servicio web externo, etc.).
	 *
	 * @return una java.util.List<Vacante> que contiene todas las entidades de vacante. Si no hay ninguna, debe devolver una lista vacía, nunca null.
	 */
